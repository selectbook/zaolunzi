...
import net.zaolunzi.framework.bean.FileParam;
import net.zaolunzi.framework.bean.FormParam;
import net.zaolunzi.framework.bean.Param;
import net.zaolunzi.framework.util.CollectionUtil;
import net.zaolunzi.framework.util.FileUtil;
import net.zaolunzi.framework.util.StreamUtil;
