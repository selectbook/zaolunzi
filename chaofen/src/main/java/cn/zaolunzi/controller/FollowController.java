...
public class FollowController {
    ...
    public String followUser(@RequestParam("userId") int userId) {
        if (hostHolder.getUser() == null) {
            return ChaofenUtil.getJSONString(999);
        }
        ...
        // 返回关注的人数
        return ChaofenUtil.getJSONString(ret ? 0 : 1, String.valueOf(followService.getFolloweeCount(hostHolder.getUser().getId(), EntityType.ENTITY_USER)));
    }
    ...
    public String followQuestion(@RequestParam("questionId") int questionId) {
        ...
        if (q == null) {
            return ChaofenUtil.getJSONString(1, "问题不存在");
        }
        ...
        return ChaofenUtil.getJSONString(ret ? 0 : 1, info);
    }
