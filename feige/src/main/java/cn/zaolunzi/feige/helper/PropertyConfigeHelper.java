package cn.zaolunzi.feige.helper;
...
public class PropertyConfigeHelper {
    ...
    private static final String PROPERTY_CLASSPATH = "/feige_remoting.properties";
    ...
    static {
        ...
        try {
            ...
            if (null == is) {
                throw new IllegalStateException("feige_remoting.properties can not found in the classpath.");
            }
            properties.load(is);
            ...
            logger.warn("load feige_remoting's properties file failed.", t);
