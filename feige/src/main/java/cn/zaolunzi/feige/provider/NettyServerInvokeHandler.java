package cn.zaolunzi.feige.provider;
...
import cn.zaolunzi.feige.zookeeper.IRegisterCenter4Provider;
...
public class NettyServerInvokeHandler extends SimpleChannelInboundHandler<FeigeRequest> {
    ...
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, FeigeRequest request) throws Exception {
        ...
        if (ctx.channel().isWritable()) {
            ...
            //根据服务调用结果组装调用返回对象
            FeigeResponse response = new FeigeResponse();
