...
import cn.zaolunzi.feige.cluster.engine.ClusterEngine;
import cn.zaolunzi.feige.model.FeigeRequest;
import cn.zaolunzi.feige.model.FeigeResponse;
import cn.zaolunzi.feige.model.ProviderService;
import cn.zaolunzi.feige.zookeeper.IRegisterCenter4Invoker;
import cn.zaolunzi.feige.zookeeper.RegisterCenter;
...
public class RevokerProxyBeanFactory implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        final FeigeRequest request = new FeigeRequest();
        //设置本次调用的唯一标识
        ...
        try {
            ...
            Future<FeigeResponse> responseFuture = fixedThreadPool.submit(RevokerServiceCallable.of(inetSocketAddress, request));
            //获取调用的返回结果
            FeigeResponse response = responseFuture.get(request.getInvokeTimeout(), TimeUnit.MILLISECONDS);
            if (response != null) {
